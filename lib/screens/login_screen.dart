...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea( // 화면 상단 바(노치) 침범 방지
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              const Text('or', style: TextStyle(color: Color(0xFF697282))),
              const SizedBox(height: 20),

              // 입력창
              _buildTextField('Email or Phone', 'Enter your email', _emailController),
              const SizedBox(height: 14),
        ...
        child: Row(
          ...
          children: [
            SvgPicture.asset(
              ...
              width: 20,
              height: 20,
              placeholderBuilder: (context) => const Icon(Icons.error, size: 20, color: Colors.grey),
            ),
