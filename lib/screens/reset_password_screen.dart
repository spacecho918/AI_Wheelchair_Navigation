                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        child: const Text(
                          'Back to Sign Up',
                          style: TextStyle(color: Color(0xFF0A0A0A), fontWeight: FontWeight.bold, fontSize: 14),
                        ),
                      ),
                    ),
        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: const Text('확인', style: TextStyle(color: Color(0xFF00C853), fontWeight: FontWeight.bold)),
            ),
          ],
        );
      },
