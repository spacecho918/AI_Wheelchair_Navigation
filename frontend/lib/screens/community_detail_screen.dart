          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFF9FAFB), // Very light grey bg for text
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  widget.report['content'],
                  style: TextStyle(color: textDark, fontSize: 14, height: 1.6),
                ),
              ),
              const SizedBox(height: 20),
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  onPressed: () {},
                  icon: Icon(Icons.edit_outlined, size: 16, color: textDark),
                  label: Text('수정 요청', style: TextStyle(color: textDark)),
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    width: 48,
                    decoration: BoxDecoration(
                      color: const Color(0xFF6EE7B7), // Light green send button
                      borderRadius: BorderRadius.circular(16),
                    ),
                    child: IconButton(
                      icon: const Icon(
